...
namespace GameCatalog.Data
{
    public partial class GameCatalogContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseSqlServer("Data Source=56-1415\\SQLEXPRESS;Initial Catalog=GameCatalog;User Id=DEVELOPER;Password=Caasd21215@@;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Permiso>(entity =>
            {
                ...
                entity.Property(e => e.PermisosId).ValueGeneratedOnAdd();
